#
#  Be sure to run `pod spec lint MobFoxSDKCoreLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Shimi Sheetrit"
  # s.authors            = { "Shimi Sheetrit" => "shimi.s@matomy.com" }
  # s.social_media_url   = "http://twitter.com/Shimi Sheetrit"
  ...
  s.source       = { :git => "https://github.com/mobfox/MobFox-iOS-SDK-Core-Lib/tree/pod_update", :tag => "v2.4.0" }
