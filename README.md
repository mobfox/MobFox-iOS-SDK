...
1. Download and unzip [MobFoxSDKCore.zip](https://sdk.starbolt.io/downloads/MobFoxSDKCore.zip) or clone this repository and extract the ```MobFoxSDKCore.embeddedframework```.
