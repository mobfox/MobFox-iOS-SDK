...
- (void)requestNativeAdWithParameter:(NSString *)serverParameter
    ...
    [MFReport log:@"admob" withInventoryHash:serverParameter andWithMessage:@"request" requestID:nil];
...
- (void)MobFoxNativeAdDidLoad:(MobFoxNativeAd *)ad withAdData:(MobFoxNativeData *)adData {
    ...
    [MFReport log:@"admob" withInventoryHash:ad.invh andWithMessage:@"impression" requestID:nil];
    
    
    /*
    MFMediatedNativeContentAd *mediatedAd = [[MFMediatedNativeContentAd alloc]
     initWithMFNativeContentAd:adData];
    
    [self.connector adapter:_adapter didReceiveMediatedNativeAd:mediatedAd];
     */
